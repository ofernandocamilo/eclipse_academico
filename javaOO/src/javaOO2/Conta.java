...
public class Conta {
	...
	boolean sacar(double valor){ //void = sem retorno; boolean = marcador booleano: retorna true ou false no m~étodo
		...
		if((saldo+limite) < valor) { //variável azul pertence a esta classe; variável vermelha não pertence a esta classe
			this.saldo -=valor;
			return false;
		} else {
			this.saldo -= valor;
